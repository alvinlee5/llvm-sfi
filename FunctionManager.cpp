...
void FunctionManager::declareMalloc()
{
	...
	malloc_Args.push_back(IntegerType::get(m_pMod->getContext(), 64));
	...
	AttributeSet func__malloc_PAL;
	{
		...
		Attrs.push_back(PAS);
		func__malloc_PAL = AttributeSet::get(m_pMod->getContext(), Attrs);
...
void FunctionManager::defineMalloc()
{
	...
	ConstantInt* const_int64_0 = ConstantInt::get(m_pMod->getContext(), APInt(64, StringRef("0"), 10)); // param for mmap
	// This is the size of block_t, need to be careful in case we change the structure and the
	// size of the struct changes.
	ConstantInt* int_val_24 = ConstantInt::get(m_pMod->getContext(), APInt(64, StringRef("24"), 10));
	ConstantPointerNull* voidPtrNull = ConstantPointerNull::get(voidPtrType);
	ConstantInt* allocMem_5Pages = ConstantInt::get(m_pMod->getContext(), APInt(64, StringRef("20480"), 10));
	ConstantInt* allocMemSize_MinusStructSize = ConstantInt::get(m_pMod->getContext(), APInt(64, StringRef("20456"), 10));
	...
	// Block  (label_193)
	AllocaInst* ptr_212 = new AllocaInst(voidPtrType, "", label_193);
	ptr_212->setAlignment(8);
	AllocaInst* ptr_213 = new AllocaInst(IntegerType::get(m_pMod->getContext(), 64), "", label_193);
	ptr_213->setAlignment(8);
	AllocaInst* ptr_block_mem = new AllocaInst(voidPtrType, "block_mem", label_193);
	ptr_block_mem->setAlignment(8);
	AllocaInst* ptr_ptr = new AllocaInst(m_pTypeManager->GetFreeMemBlockPtTy(), "ptr", label_193);
	ptr_ptr->setAlignment(8);
	AllocaInst* ptr_newptr_214 = new AllocaInst(m_pTypeManager->GetFreeMemBlockPtTy(), "newptr", label_193);
	ptr_newptr_214->setAlignment(8);
	...
	ptr_222->setAlignment(8);
	GetElementPtrInst* ptr_223 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_222, {
	int_val_0,
	int_val_0
	}, "", label_195);
	LoadInst* int64_224 = new LoadInst(ptr_223, "", false, label_195);
	int64_224->setAlignment(8);
	LoadInst* int64_225 = new LoadInst(ptr_213, "", false, label_195);
	int64_225->setAlignment(8);
	BinaryOperator* int64_226 = BinaryOperator::Create(Instruction::Add, int64_225, int_val_24, "", label_195);
	...
	ptr_229->setAlignment(8);
	CastInst* int64_230 = new PtrToIntInst(ptr_229, IntegerType::get(m_pMod->getContext(), 64), "", label_196);
	BinaryOperator* int64_231 = BinaryOperator::Create(Instruction::Add, int64_230, int_val_24, "", label_196);
	...
	GetElementPtrInst* ptr_255 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_254, {
	int_val_0,
	int_val_1
	}, "", label_199);
	LoadInst* ptr_256 = new LoadInst(ptr_255, "", false, label_199);
	ptr_256->setAlignment(8);
	...
	Attrs.push_back(PAS);
	ptr_264_PAL = AttributeSet::get(m_pMod->getContext(), Attrs);
	...
	void_270->setAlignment(8);
	BranchInst::Create(label_211, label_203);

	// Block  (label_204)
	LoadInst* ptr_272 = new LoadInst(ptr_ptr, "", false, label_204);
	ptr_272->setAlignment(8);
	GetElementPtrInst* ptr_273 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_272, {
	int_val_0,
	int_val_1
	}, "", label_204);
	...
	ptr_275->setAlignment(8);
	GetElementPtrInst* ptr_276 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_275, {
	int_val_0,
	int_val_2
	}, "", label_204);
	StoreInst* void_277 = new StoreInst(m_pTypeManager->GetFreeMemBlockNull(), ptr_276, false, label_204);
	void_277->setAlignment(8);
	LoadInst* ptr_278 = new LoadInst(ptr_ptr, "", false, label_204);
	ptr_278->setAlignment(8);
	GetElementPtrInst* ptr_279 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_278, {
	int_val_0,
	int_val_0
	}, "", label_204);
	...
	GetElementPtrInst* ptr_282 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_281, {
	int_val_0,
	int_val_0
	}, "", label_204);
	LoadInst* int64_283 = new LoadInst(ptr_282, "", false, label_204);
	int64_283->setAlignment(8);
	LoadInst* int64_284 = new LoadInst(ptr_213, "", false, label_204);
	int64_284->setAlignment(8);
	...
	AttributeSet void_292_PAL;
	void_292->setAttributes(void_292_PAL);

	LoadInst* ptr_293 = new LoadInst(ptr_ptr, "", false, label_205);
	ptr_293->setAlignment(8);
	CastInst* int64_294 = new PtrToIntInst(ptr_293, IntegerType::get(m_pMod->getContext(), 64), "", label_205);
	BinaryOperator* int64_295 = BinaryOperator::Create(Instruction::Add, int64_294, int_val_24, "", label_205);
	...
	void_297->setAlignment(8);
	BranchInst::Create(label_211, label_205);

	// Block  (label_206)
	LoadInst* ptr_299 = new LoadInst(ptr_ptr, "", false, label_206);
	ptr_299->setAlignment(8);
	GetElementPtrInst* ptr_300 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_299, {
	int_val_0,
	int_val_0
	}, "", label_206);
	LoadInst* int64_301 = new LoadInst(ptr_300, "", false, label_206);
	int64_301->setAlignment(8);
	...
	ptr_305->setAlignment(8);
	CastInst* int64_306 = new PtrToIntInst(ptr_305, IntegerType::get(m_pMod->getContext(), 64), "", label_207);
	BinaryOperator* int64_307 = BinaryOperator::Create(Instruction::Add, int64_306, int_val_24, "", label_207);
...
void FunctionManager::declareScanMerge()
{
	...
	AttributeSet func_scan_merge_PAL;
	{
		SmallVector<AttributeSet, 4> Attrs;
		AttributeSet PAS;
		{
		...
		Attrs.push_back(PAS);
		func_scan_merge_PAL = AttributeSet::get(m_pMod->getContext(), Attrs);
...
void FunctionManager::defineScanMerge()
{
	...
	// Block  (label_99)
	AllocaInst* ptr_curr_108 = new AllocaInst(m_pTypeManager->GetFreeMemBlockPtTy(), "curr", label_99);
	ptr_curr_108->setAlignment(8);
	AllocaInst* ptr_header_curr = new AllocaInst(IntegerType::get(m_pMod->getContext(), 64), "header_curr", label_99);
	ptr_header_curr->setAlignment(8);
	AllocaInst* ptr_header_next = new AllocaInst(IntegerType::get(m_pMod->getContext(), 64), "header_next", label_99);
	ptr_header_next->setAlignment(8);
	...
	void_110->setAlignment(8);
	BranchInst::Create(label_100, label_99);

	// Block  (label_100)
	LoadInst* ptr_112 = new LoadInst(ptr_curr_108, "", false, label_100);
	ptr_112->setAlignment(8);
	GetElementPtrInst* ptr_113 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_112, {
			int_val_0,
			int_val_1
	}, "", label_100);
	...
	CastInst* int64_118 = new PtrToIntInst(ptr_117, IntegerType::get(m_pMod->getContext(), 64), "", label_101);
	...
	GetElementPtrInst* ptr_121 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_120, {
			int_val_0,
			int_val_1
	}, "", label_101);
	LoadInst* ptr_122 = new LoadInst(ptr_121, "", false, label_101);
	ptr_122->setAlignment(8);
	CastInst* int64_123 = new PtrToIntInst(ptr_122, IntegerType::get(m_pMod->getContext(), 64), "", label_101);
	...
	GetElementPtrInst* ptr_135 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_134, {
			int_val_0,
			int_val_1
	}, "", label_102);
	LoadInst* ptr_136 = new LoadInst(ptr_135, "", false, label_102);
	ptr_136->setAlignment(8);
	GetElementPtrInst* ptr_137 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_136, {
			int_val_0,
			int_val_0
	}, "", label_102);
	LoadInst* int64_138 = new LoadInst(ptr_137, "", false, label_102);
	int64_138->setAlignment(8);
	BinaryOperator* int64_139 = BinaryOperator::Create(Instruction::Add, int64_138, int_val_24, "", label_102);
	LoadInst* ptr_140 = new LoadInst(ptr_curr_108, "", false, label_102);
	ptr_140->setAlignment(8);
	GetElementPtrInst* ptr_141 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_140, {
			int_val_0,
			int_val_0
	}, "", label_102);
	LoadInst* int64_142 = new LoadInst(ptr_141, "", false, label_102);
	int64_142->setAlignment(8);
	...
	void_144->setAlignment(8);
	LoadInst* ptr_145 = new LoadInst(ptr_curr_108, "", false, label_102);
	ptr_145->setAlignment(8);
	GetElementPtrInst* ptr_146 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_145, {
			int_val_0,
			int_val_1
	}, "", label_102);
	LoadInst* ptr_147 = new LoadInst(ptr_146, "", false, label_102);
	ptr_147->setAlignment(8);
	GetElementPtrInst* ptr_148 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_147, {
			int_val_0,
			int_val_1
	}, "", label_102);
	...
	GetElementPtrInst* ptr_151 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_150, {
			int_val_0,
			int_val_1
	}, "", label_102);
	...
	ptr_153->setAlignment(8);
	GetElementPtrInst* ptr_154 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_153, {
			int_val_0,
			int_val_1
	}, "", label_102);
	...
	GetElementPtrInst* ptr_160 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_159, {
			int_val_0,
			int_val_1
	}, "", label_103);
	LoadInst* ptr_161 = new LoadInst(ptr_160, "", false, label_103);
	ptr_161->setAlignment(8);
	GetElementPtrInst* ptr_162 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_161, {
			int_val_0,
			int_val_2
	}, "", label_103);
	StoreInst* void_163 = new StoreInst(ptr_158, ptr_162, false, label_103);
	void_163->setAlignment(8);
	...
	ptr_167->setAlignment(8);
	GetElementPtrInst* ptr_168 = GetElementPtrInst::Create(m_pTypeManager->GetFreeMemBlockStructTy(), ptr_167, {
			int_val_0,
			int_val_1
	}, "", label_106);
...
void FunctionManager::declareFree()
{
	...
	AttributeSet func__free_PAL;
	{
		...
		Attrs.push_back(PAS);
		func__free_PAL = AttributeSet::get(m_pMod->getContext(), Attrs);
	}
...
void FunctionManager::defineFree()
{
	...
	// Block  (label_173)
	AllocaInst* ptr_174 = new AllocaInst(voidPtrType, "", label_173);
	ptr_174->setAlignment(8);
	...
	CastInst* int64_177 = new PtrToIntInst(ptr_176, IntegerType::get(m_pMod->getContext(), 64), "", label_173);
	BinaryOperator* int64_178 = BinaryOperator::Create(Instruction::Sub, int64_177, int_val_24, "", label_173);
